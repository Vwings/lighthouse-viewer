...
- Change hash href to modify location.hash
...
- 'Save as HTML' generates standalone html.
- Support changing theme. Emit event when changing theme inside lighthouse report.
- 'Print' is removed (still avaliable in exported HTML).
